...
public class AgentMypropertiesForm extends JFrame {
    private JTable propertiesTable;
    private DefaultTableModel tableModel;
    private JButton refreshBtn, closeBtn;
    private int agentId;

    public AgentMypropertiesForm(int agentId) {
    ...
    public static void main(String[] args) {
        // Example agentId = 2
        SwingUtilities.invokeLater(() -> new AgentMypropertiesForm(2).setVisible(true));
    }
}
