...
public class AgentViewPropertiesForm extends JFrame {
    private JTable propertiesTable;
    private DefaultTableModel tableModel;
    private JButton refreshBtn, closeBtn;
    private int agentId;

    public AgentViewPropertiesForm(int agentId) {
        this.agentId = agentId;

        setTitle("My Properties - Agent");
        setSize(800, 400);
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setLayout(new BorderLayout(10, 10));

        JLabel header = new JLabel("My Properties", JLabel.CENTER);
    ...
    public static void main(String[] args) {
        // Example agentId = 2
        SwingUtilities.invokeLater(() -> new AgentViewPropertiesForm(2).setVisible(true));
    }
}
