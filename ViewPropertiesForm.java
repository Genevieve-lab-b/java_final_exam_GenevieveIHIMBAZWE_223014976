...
public class ViewPropertiesForm extends JFrame {
    ...
    public ViewPropertiesForm() {
        ...
        JLabel header = new JLabel("Property Listings", JLabel.CENTER);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ViewPropertiesForm().setVisible(true));
    }
}
