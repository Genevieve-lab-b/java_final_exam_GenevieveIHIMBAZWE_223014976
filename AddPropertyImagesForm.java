...
public class AddPropertyImagesForm extends JFrame {
    ...
    private void uploadImage() {
        ...
        String imageUrl = selectedFile.getAbsolutePath(); // save local path
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new AddPropertyImagesForm().setVisible(true));
    }
}
